...
class MyWebBody extends StatefulWidget {
  ...
  @override
  State<MyWebBody> createState() => _MyWebBodyState();
}

List<User> userDetailList = [];
bool isVisible = false;

class _MyWebBodyState extends State<MyWebBody> {
  @override
        ...
        child: FloatingActionButton(
          ...
          onPressed: () async {
            ...
            final newUser = await Navigator.push<User>(
              context,
              MaterialPageRoute(builder: (context) => WebUserPage()),
            );
